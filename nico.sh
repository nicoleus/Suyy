clear
echo "\033[34;1m HORAS HITA SUDE!!!"
sleep 1
echo "\033[35;1m Selamat Datang Di Tools Nicoleus Sitorus" | lolcat
sleep 1
echo "\033[31;1m:)  Semoga Bermanfaat  (:"
sleep 1
echo "\033[31;1m:) Silahkan Pilih Lae!!" | lolcat
clear
